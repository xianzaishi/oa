...
<!-- end of main_content -->
  <div id="footer">
    <div id="copyright">
      ...
      <div style="float:left; padding:14px 10px 10px 10px;"> 赤峰市第二医院.&copy; All Rights Reserved 2014- By <a href="http://www.cfdeyy.com" style="color:#772c17;">www.cfdeyy.com</a></div>
    </div>
