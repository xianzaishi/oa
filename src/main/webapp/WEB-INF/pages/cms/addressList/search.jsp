...
<table width="960px" align="center" border="0">
	<tr>
		...
		<security:authorize access="hasRole('ROLE_ADMIN')">
			<a href="${contextPath }/addresslist/add" class="myButton">添加</a>&nbsp;
			<a id="deleteAddress" href="javascript:void(0)" class="myButton">删除</a>
		</security:authorize>
		</td>
	</tr>
</table>
...
<tr>
	<th>&nbsp;<th>姓名</th><th>电话</th><th>所属部门</th>
</tr>
<c:forEach items="${addressList }" var="addressList" varStatus="idx">
<tr>
	<td><input id="${addressList.id }" name="checkbox" type="checkbox" /></td>
	<td width="320px"><div id="${addressList.id }" name="preview"><c:out value="${addressList.name }"/></div></td>
	<td width="320px"><c:out value="${addressList.mobile }"/></td>
	<td width="320px"><c:out value="${addressList.dept }"/></td>
</tr>
</c:forEach>
</table>
<br/>
...
$(function(){
	...
	$('#deleteAddress').click(function(){
		...
		var url = "${contextPath }/addresslist/delete/ids/" + ids;
	...
	$('#search').click(function(){
		...
		var url = "${contextPath }/addresslist/search/keyword/" + keyword + "/page/1";
