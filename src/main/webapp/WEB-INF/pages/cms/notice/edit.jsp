...
<center><br/>
<form:form id="addNoticeForm" commandName="notice" method="POST">
<table>
	<tr>
		<td>标题：</td>
...
<div style="text-align:center">
	<a class="myButton" id="editContentButton" href="javascript:void(0)">确定</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$(function(){
	...
	$("#editContentButton").click(function(){
		...
		var url = "${contextPath }/cms/notice/edit/submit";
		$("#addNoticeForm").attr("action", url);
