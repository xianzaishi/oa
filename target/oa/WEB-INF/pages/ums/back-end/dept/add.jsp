...
<div id="formwrapper">
<br/>
<form:form id="departmentForm" commandName="department" method="post">
<fieldset>
<legend>新增部门</legend>
<div>
<label for="Department">部门名</label>
<form:input type="text" id="department" path="department" size="20" maxlength="30" />
*(最多30个字符)<br/>
</div>
<div class="enter">
