...
<center><br/>
<form:form id="addMailForm" commandName="mailDto" method="POST">
<table>
	<tr>
		<td>收件人：</td>
		<td>&nbsp;<form:input id="to" path="to" style="width:400px;"/><font size="2" color="red">&nbsp;收件人之间用半角分号;分隔</font>
		</td>
	</tr>
	<tr>
		<td>标题：</td>
		<td>&nbsp;<form:input id="title" path="title" style="width:400px;"/><font size="2" color="red">&nbsp;*</font>
		</td>
	</tr>
	<tr>
		<td>内容：</td>
		<td><form:textarea id="content" path="content" style="width:500px; height:200px;"></form:textarea></td>
	</tr>
	<tr>
		<td>附件：</td>
		<td>
			<input type="file" id="file" />
			<form:hidden id="from" path="from" />
...
$(function(){
	$("#addContentButton").click(function(){
		...
		var url = "${contextPath}/mail/add/submit";
		$("#addMailForm").attr("action", url);
		$("#addMailForm").submit();
	});
});
</script>
