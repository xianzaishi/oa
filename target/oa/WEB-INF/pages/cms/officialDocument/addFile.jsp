...
<form id="addDeptFileForm" method="POST" enctype="multipart/form-data">
<table>
	<tr>
		<td>文件：</td>
...
<div style="text-align:center">
	<a class="myButton" id="addDeptFileButton" href="javascript:void(0)">确定</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$(function(){
	//添加
	$("#addDeptFileButton").click(function(){
		async = true;
		// 表单验证
		if($.trim($("#file").val()) == ""){
			alert("上传文件不能为空");
		...
		var url = "${contextPath }/cms/official/dept/file/add";
		$("#addDeptFileForm").attr("action", url);
		$("#addDeptFileForm").submit();
	});
});
</script>
