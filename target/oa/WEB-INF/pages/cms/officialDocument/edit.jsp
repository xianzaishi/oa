...
<form:form id="editDeptFolderForm" commandName="deptFolder" method="POST">
<table>
	<tr>
		<td>名称：</td>
...
<div style="text-align:center">
	<a class="myButton" id="editDeptFolderButton" href="javascript:void(0)">确定</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$(function(){
	//添加
	$("#editDeptFolderButton").click(function(){
		async = true;
		// 表单验证
		if($.trim($("#name").val()) == ""){
			alert("名称不能为空");
		...
		var url = "${contextPath }/cms/official/dept/edit";
		$("#editDeptFolderForm").attr("action", url);
		$("#editDeptFolderForm").submit();
	});
});
</script>
